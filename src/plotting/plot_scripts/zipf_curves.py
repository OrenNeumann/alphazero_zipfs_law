...
def plot_main_zipf_curves(res=300):
    ...
    plt.annotate('Connect Four: ' + labels[0], xy=[10**4, 4*10**2], xytext=[3*10**5, 8*10**3], arrowprops=dict(arrowstyle='->'), fontsize=tf)
    plt.annotate('Pentago: ' + labels[1], xy=[10**3, 4*10**2], xytext=[10**2, 4*10**1], arrowprops=dict(arrowstyle='->'), fontsize=tf)
