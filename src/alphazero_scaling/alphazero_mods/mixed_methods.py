...
from src.alphazero_scaling.alphazero_mods import resignation 


class ResignationUniform(base.AlphaZero):
    """ AlphaZaro with resignation and uniform sampling. """
    ...
    def _play_game(self, logger, game_num, game, bots, temperature, temperature_drop):
        ...
        ###
        trajectory = resignation.Trajectory()
        actions = []
